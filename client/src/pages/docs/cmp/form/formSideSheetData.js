const formSideSheetData = {
  ...
  selectStaticStatic: {
    ...
    props: [
      ...
      { name: "width", description: "(Optional) Default width is 320" },
      {
        name: "valueField",
        description:
          "(Optional) Name of the id field on the item object. Default id"
      },
      {
        name: "textField",
        description:
          "(Optional) Name of the name field on the item object. Default name"
      }
    ]
  },
  selectStaticDynamic: {
    ...
    props: [
      ...
      { name: "defaultValue", description: "Default value" },
      {
        name: "source",
        description:
          "Name of the resource to be called to the server under api: /api/uiprop/:source , the result will be stored on ui.reducer as [sourceName]: listOfItems"
      },
      { name: "width", description: "(Optional) Default width is 320" },
      {
        name: "valueField",
  ...
  dateField: {
    ...
    props: [
      { name: "name", description: "Field name" },
      { name: "label", description: "Field label" },
      { name: "component", description: "DatePicker" }
    ]
  },
  textAreaField: {
    title: "TextArea",
